...
public class Final_projectEditorTarget : TargetRules // Define editor target rules class inheriting from TargetRules [EDITOR TARGET RULES CLASS]
{ // Start of class body [CLASS BODY START]
	public Final_projectEditorTarget(TargetInfo Target) : base(Target) // Constructor taking target info parameter and calling base constructor [CONSTRUCTOR]
	{ // Start of constructor body [CONSTRUCTOR BODY START]
		Type = TargetType.Editor; // Set target type to Editor for development environment executable [TARGET TYPE ASSIGNMENT]
...
} // End of editor target rules class [EDITOR TARGET RULES CLASS END]
